...
contract SimpleBank {
    ...
    function deposit() public payable returns (uint) {
      ...
      require (enrolled[msg.sender], "You must be enrolled first.");
    ...
    function withdraw(uint withdrawAmount) public payable returns (uint) {
      ...
      require (balances[msg.sender] >= withdrawAmount, "Insufficient deposits.");
      ...
      emit LogWithdrawal(_withdrawer, withdrawAmount, balances[msg.sender]);
